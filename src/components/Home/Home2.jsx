...
import './Home.css';
import './Right Division/Globe2/NewHome.css';
...
import GlobeE3 from "./Right Division/Globe2/Globe";
...
const Home2 = (props) => {
  ...
  return <div className="home-container">
    <Navbar style={{width: '100%', position: 'fixed', zIndex: '5', display: !scrollSize ? 'none' : '', backgroundColor: !scrollSize ? 'transparent' : '#fff'}}>
      <UserPanel 
